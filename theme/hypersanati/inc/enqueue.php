...
//     // ------------------------------------------
//     // OTP modal: باید در همه‌ی صفحات لود شود
//     // چون دکمه‌ی بازکننده‌ی آن (#ui-open-otp) در header.php
//     // و برای همه‌ی صفحات سایت است، نه فقط my-account.
//     // ------------------------------------------
//     $enqueue_style('hypersanati-otp', 'css/myaccount/otp.css');
