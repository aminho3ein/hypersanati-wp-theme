...
<div class="all-elements d-flex flex-column flex-lg-row gap-3 gap-lg-5 p-3 p-md-4 p-lg-5">

  <!-- profile-btn-navigation -->
  <div class="my-profie-sec w-100 w-lg-auto">
    <div class="profile-reqtangle w-100 flex-row flex-wrap flex-lg-column h-auto py-3 px-2">
  ...
  <!-- 1) حساب کاربری من (پیش‌فرض active) -->
  <div class="info-sec account-info-section w-100">
  ...
  <!-- 2) تاریخچه خرید -->
  <div class="info-sec perchase-history w-100">
  ...
  </div> <!-- /.perchase-history -->

  <!-- 3) لیست احتمالا بخرم (Wishlist) -->
  <div class="info-sec wishlist w-100">
  ...
  <!-- 4) پشتیبانی -->
  <div class="info-sec support-section w-100">
